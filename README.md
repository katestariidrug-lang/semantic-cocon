...
- read-only инструменты могут показывать:
  ...
  - **Allowed actions / Forbidden actions** как **отражение контракта README.md**
- при показе Allowed/Forbidden:
  - это **информация**, а не “разрешение”
...
- отображать **информационную проекцию** контрактных правил README.md в виде:
  ...
  - с причиной в терминах **контрактных предикатов** (например: “approval missing”, “merge-state exists”, “fingerprint mismatch”),
...
- **наблюдаемую классификацию FSM-состояния** как отражение таблицы FSM из README.md
  (это не “решение”, а отображение классификации по фактам)
- **Allowed actions / Forbidden actions** с причиной как ссылкой на контрактное условие  
  (информация, не гарантия; enforcing CLI всё равно может вернуть FAIL/BLOCKER)
